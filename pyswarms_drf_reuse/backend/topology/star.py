...
class Star(Topology):
    ...
    def compute_gbest(self, swarm, **kwargs):
        ...
        try:
            ...
            #    )
            #print("In star, position: ", self.neighbor_idx) #沒作用
            #print("In star, swarm.position: ", swarm.position) 
            #print("In star, swarm.pbest_cost: ", swarm.pbest_cost) 
            #print("In star, swarm.best_cost: ", swarm.best_cost) 
            if np.min(swarm.pbest_cost) < swarm.best_cost:
                print("In np.min(swarm.pbest_cost) < swarm.best_cost")
